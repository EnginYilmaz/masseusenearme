...
const api = new Frisbee({
  baseURI: 'https://api.authy.com/protected/json/phones/verification/start',
  headers: {
...
export default class PhoneVerificationAndroid extends Component {
  ...
  _getCode = () => {
    ...
    fetch("https://api.authy.com/protected/json/phones/verification/start", {
      body: "api_key=8MYszdyfAG0bLWXoqLqqwSnXBfGE7iPD&via=sms&phone_number=5324029677&country_code=90",
      headers: {
      ...
      .then((responseJson) => {
        Alert.alert("geri dönüş sağlandı ama sms nerede")
        this.setState({
          spinner: false,
          enterCode: true,
...
AppRegistry.registerComponent('PhoneVerificationAndroid', () => PhoneVerificationAndroid);